...
function PricesPlaceholder() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-syscom-700">Precios</h1>
        <p className="text-sm text-gray-500 mt-1">Gestión de listas de precios</p>
      </div>
      <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
        ...
        <p className="text-gray-500">La gestión de precios estará disponible próximamente</p>
      </div>
    </div>
  )
}
